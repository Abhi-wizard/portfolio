...
export const projectData = [
  {
    ...
    imageFolder: assetUrl("/projects/agriculture"),
    images: []
  },
  {
    id: "kal",
  ...
  honors: [
    {
      ...
      url: assetUrl("/certificates/5g_paper.pdf")
    },
    {
      name: '"Crop Yield Prediction Using ML" Paper at SRM Institute',
      url: assetUrl("/certificates/crop_yield_paper.pdf")
    },
    {
    ...
    },
    {
      ...
      url: assetUrl("/certificates/hibot_award.pdf")
    }
  ]
};
